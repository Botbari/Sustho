...
const MyCards: React.FC<MyCardsProps> = ({ onOpenBenefits }) => {
  return (
    <section id="my-cards" className="py-12 sm:py-20 px-4 sm:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#006A4E] mb-8 sm:mb-12 flex items-center gap-2 sm:gap-3">
          <svg
          ...
          <div className="group relative overflow-hidden bg-gradient-to-br from-[#006A4E] to-[#22C55E] rounded-[24px] p-6 md:p-8 shadow-xl border-l-8 border-[#F42A41] transition-all hover:scale-[1.01] duration-300">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              <div className="w-full md:w-1/2 aspect-video bg-black rounded-xl overflow-hidden relative shadow-inner border border-white/10">
                ...
                >
                  <source
                    src="https://assets.mixkit.co/videos/preview/mixkit-digital-animation-of-a-human-brain-and-data-processing-34446-large.mp4"
                    type="video/mp4"
                  />
                </video>
              </div>
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                ...
                <p className="text-[#F9FAF9] text-sm leading-relaxed mb-4">
                  বিনা চিকিৎসায় কোনো মৃত্যু নয়। আপনার কার্ডের মাধ্যমে ডিজিটাল
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                ...
                <p className="text-white text-sm leading-relaxed mb-4">
                  মা ও শিশুর নিরাপদ ভবিষ্যতের জন্য। সরকারি সহায়তায় ফ্রি
                  স্বাস্থ্য পরীক্ষা ও বিশেষ ছাড়।
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 pt-4 border-t border-white/10 flex justify-between items-center">
              <div className="flex -space-x-3">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full border-2 border-[#F42A41] bg-gray-200 overflow-hidden"
                  >
                    <img
                ...
                <div className="w-8 h-8 rounded-full border-2 border-[#F42A41] bg-white flex items-center justify-center text-[#F42A41] text-[10px] font-bold">
                  +2
                </div>
              </div>
