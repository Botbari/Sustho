...
const MediaShowcase: React.FC = () => {
  return (
    <section className="py-12 sm:py-20 px-4 sm:px-6 bg-[#F9FAF9] border-t border-gray-100">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#006A4E] text-center mb-8 sm:mb-12">
          আমাদের লক্ষ্য ও সেবা
        </h2>

        <div className="bg-white p-4 sm:p-6 md:p-10 rounded-2xl sm:rounded-[32px] shadow-lg border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
            {/* Image Box */}
            <div className="overflow-hidden rounded-[24px] shadow-md group">
              <img
                src={
                  "https://6971273ec0356527951e30fc.imgix.net/sastho-seba.jpeg"
                }
                alt="Health Mission"
                className="w-full h-[300px] object-cover transform group-hover:scale-110 transition-transform duration-700"
              />
              <div className="p-4 bg-white">
                <p className="text-[#006A4E] font-bold text-lg">
                  মানবিক স্বাস্থ্যসেবা
                </p>
                <p className="text-gray-500 text-sm">
                  প্রত্যন্ত অঞ্চলে স্বাস্থ্য সেবা পৌঁছে দেওয়াই আমাদের লক্ষ্য।
                </p>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-[24px] shadow-md group relative">
              ...
              <div className="p-4 bg-white">
                <p className="text-[#F42A41] font-bold text-lg">
                  অত্যাধুনিক প্রযুক্তি
                </p>
                <p className="text-gray-500 text-sm">
                  এআই প্রযুক্তির মাধ্যমে রোগ নির্ণয় ও দ্রুত সেবা প্রদান।
                </p>
              </div>
            </div>
          </div>
