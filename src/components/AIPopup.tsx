                ...
                <div className="flex items-center space-x-3 md:space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm md:text-base lg:text-lg">
                      স্বাস্থ্য পরামর্শ ও প্রেসক্রিপশন বিশ্লেষণ
                    </p>
                  </div>
                </div>
                <motion.button
                  ...
                  <div className="flex-1 overflow-y-auto space-y-3 md:space-y-4 mb-3 md:mb-4 bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl md:rounded-2xl p-3 md:p-4 min-h-0">
                    <AnimatePresence>
                      {messages.map((message) => (
                        ...
                        >
                          <div
                            className={`flex items-start space-x-2 md:space-x-3 max-w-[85%] md:max-w-xs ${
                              message.sender === "user"
                  ...
                  >
                    <div className="text-center mb-3 md:mb-4">
                      ...
                      <p className="text-gray-600 text-sm md:text-base">
                        আপনার মেডিকেল প্রেসক্রিপশনের টেক্সট এখানে পেস্ট করুন
                      </p>
                    </div>
                      ...
                      {messages
                        .filter(
                          (msg) =>
                            ...
                            (msg.sender === "bot" &&
                              messages.some((m) => m.type === "prescription")),
                        )
                        .map((message) => (
                          <motion.div
                            key={message.id}
