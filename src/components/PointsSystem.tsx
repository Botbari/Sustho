...
const PointsSystem: React.FC = () => {
  ...
  return (
    <section id="points" className="py-12 sm:py-20 px-4 sm:px-6 bg-[#F3F4F6]">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#006A4E] mb-4">
          How Your Points Work
        </h2>
        <p className="text-[#6B7280] max-w-2xl mx-auto mb-10 sm:mb-16 text-base sm:text-lg px-2">
          সাসথ্য আইআই (Sustho AI) কার্ডের মাধ্যমে আপনি যত বেশি স্বাস্থ্য সচেতন
          হবেন, তত বেশি পয়েন্ট অর্জন করবেন।
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {pointsData.map((item, idx) => (
            <div
              key={idx}
              className={`bg-white p-6 sm:p-10 rounded-2xl sm:rounded-[24px] shadow-sm border-b-4 ${item.color} hover:shadow-md transition-shadow group`}
            >
