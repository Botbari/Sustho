  ...
  const commonDiseases = [
    {
      ...
      description: t('language') === 'bn' ? 'শরীরের তাপমাত্রা বৃদ্ধি' : 'Increased body temperature'
    },
    {
      ...
      description: t('language') === 'bn' ? 'নাক বন্ধ ও কাশি' : 'Nasal congestion & cough'
    },
    {
      name: 'মাথা ব্যথা',
      icon: '🧠',
            ...
            >
              ...
              {medicineSuggestions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-lg">এখনো কোন ডাক্তার পরামর্শ নেই</p>
                  <p className="text-gray-400 text-sm mt-2">চ্যাটবট থেকে ডাক্তার  পরামর্শ নিন</p>
                </div>
              ) : (
