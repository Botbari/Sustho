...
const HealthDiseasePage: React.FC = () => {
  ...
  const commonDiseases = [
    ...
    {
      name: t("language") === "bn" ? "সর্দি-কাশি" : "Cold & Cough",
      icon: "🤧",
      ...
      description:
        t("language") === "bn" ? "নাক বন্ধ ও কাশি" : "Nasal congestion & cough",
    },
    {
      name: "মাথা ব্যথা",
      icon: "🧠",
  ...
  const addMedicineSuggestion = (
    medicine: Omit<MedicineSuggestion, "id" | "timestamp">,
  ) => {
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* <div>
              <Swiper
                ...
                speed={1600}
              >
                <SwiperSlide className="h-64">Slide 1</SwiperSlide>
                <SwiperSlide className="h-64">Slide 2</SwiperSlide>
              </Swiper>
            </div> */}
            <motion.div
              ...
              {selectedDiseases.length > 0 && (
                ...
                >
                  ...
                  >
                    ...
                    <span>
                      চ্যাটবটে পাঠান ({selectedDiseases.length}টি রোগ)
                    </span>
                  </motion.button>
                </motion.div>
              )}
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">AI থেকে প্রাপ্ত ডাক্তার পরামর্শ</p>
              </div>
              ...
              {medicineSuggestions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-lg">
                    এখনো কোন ডাক্তার পরামর্শ নেই
                  </p>
                  <p className="text-gray-400 text-sm mt-2">
                    চ্যাটবট থেকে ডাক্তার পরামর্শ নিন
                  </p>
                </div>
              ) : (
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-600">
                            মাত্রা: {medicine.dosage}
                          </span>
                        </div>
                        <div className="flex items-center">
                          <span className="w-2 h-2 bg-green-500 rounded-full mr-2"></span>
                          <span className="text-gray-600">
                            সময়: {medicine.frequency}
                          </span>
                        </div>
                        <div className="flex items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-lg">
                  স্বাস্থ্য পরামর্শ ও রিপোর্ট বিশ্লেষণ
                </p>
              </div>
            </div>
          </div>
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <h4 className="text-xl font-bold text-gray-800 mb-2">
                    টেস্ট রিপোর্ট আপলোড করুন
                  </h4>
                  <p className="text-gray-600">
                    আপনার মেডিকেল টেস্ট রিপোর্টের টেক্সট এখানে পেস্ট করুন
                  </p>
                </div>
              ...
              <div className="flex-1 overflow-y-auto space-y-4 bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-4">
                <AnimatePresence>
                  {messages
                    .filter(
                      (msg) =>
                        msg.text.includes("টেস্ট রিপোর্ট") ||
                        msg.text.includes("রিপোর্ট বিশ্লেষণ"),
                    )
                    .map((message) => (
                      <motion.div
                        key={message.id}
