...
const NotificationPage: React.FC = () => {
  ...
  const parsePrescription = (text: string): Medicine[] => {
    ...
    lines.forEach((line, index) => {
      if (
        line.toLowerCase().includes("প্যারাসিটামল") ||
        ...
        const medicine: Medicine = {
          id: (index + 1).toString(),
          name: line.includes("প্যারাসিটামল")
            ? "প্যারাসিটামল"
            : line.includes("অ্যামোক্সিসিলিন")
              ? "অ্যামোক্সিসিলিন"
              : "ওষুধ",
          dosage: "৫০০মিগ্রা",
          frequency: "দিনে ৩ বার",
  ...
  const handleAddPrescription = () => {
    ...
    const prescription: Prescription = {
      ...
      nextVisit: newPrescription.nextVisit
        ? new Date(newPrescription.nextVisit)
        : undefined,
    };
  ...
  return (
    <div className="min-h-screen py-6 sm:py-8 px-3 sm:px-4">
      <div className="container mx-auto">
        ...
        >
          <motion.div
            className="inline-flex items-center justify-center w-16 h-16 sm:w-20 md:w-24 sm:h-20 md:h-24 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white mb-4 sm:mb-6 shadow-2xl relative"
            whileHover={{ scale: 1.1, rotate: 10 }}
            transition={{ type: "spring", stiffness: 400 }}
          >
            <Bell className="w-8 h-8 sm:w-10 md:w-12 sm:h-10 md:h-12" />
            {unreadCount > 0 && (
              <motion.div
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-4">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <motion.div
                    className="w-12 h-12 sm:w-14 md:w-16 sm:h-14 md:h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-lg"
                    whileHover={{ rotate: 10, scale: 1.1 }}
                  >
                    <Settings className="w-6 h-6 sm:w-7 md:w-8 sm:h-7 md:h-8" />
                  </motion.div>
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600">
                      আপনার রিমাইন্ডার কাস্টমাইজ করুন
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-lg">
                      অটো রিমাইন্ডার সেট করতে প্রেসক্রিপশন আপলোড করুন
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  সংরক্ষিত প্রেসক্রিপশন ও ওষুধের তালিকা
                </p>
              </div>
              ...
              {prescriptions.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    প্রেসক্রিপশন যোগ করে রিমাইন্ডার সেট করুন
                  </p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">
                            আপলোড:{" "}
                            {prescription.uploadDate.toLocaleDateString(
                              "bn-BD",
                            )}
                          </p>
                        </div>
                        ...
                        {prescription.nextVisit && (
                          <div className="text-right">
                            ...
                            <p className="font-bold text-purple-600">
                              {prescription.nextVisit.toLocaleDateString(
                                "bn-BD",
                              )}
                            </p>
                          </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {prescription.medicines.map((medicine, i) => (
                          <div
                            key={medicine.id}
                            className="bg-white/60 rounded-xl p-4 border border-teal-200"
                          >
                ...
                <div className="h-[500px] overflow-y-auto p-6 space-y-4 bg-gradient-to-br from-gray-50 to-blue-50">
                  {notifications.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400 text-sm mt-2">
                        প্রেসক্রিপশন যোগ করলে রিমাইন্ডার পাবেন
                      </p>
                    </div>
                  ) : (
                    <AnimatePresence>
                          ...
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="flex-1">
                                <h4
                                  className={`font-bold ${notification.isRead ? "text-gray-600" : "text-gray-800"}`}
                                >
                                  {notification.title}
                                </h4>
                                <p
