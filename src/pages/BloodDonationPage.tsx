...
const BloodDonationPage: React.FC = () => {
  ...
  const locations =
    t("language") === "bn"
      ? ["ঢাকা", "চট্টগ্রাম", "রাজশাহী", "সিলেট", "খুলনা", "বরিশাল"]
      : ["Dhaka", "Chittagong", "Rajshahi", "Sylhet", "Khulna", "Barisal"];
  const urgencyLevels =
    t("language") === "bn"
      ? ["অতি জরুরি", "জরুরি", "মাঝারি"]
      : ["Very Urgent", "Urgent", "Moderate"];
  ...
  const filteredDonors = donors.filter((donor) => {
    const matchesBloodGroup =
      searchBloodGroup === "all" || donor.bloodGroup === searchBloodGroup;
    const matchesLocation =
      searchLocation === "all" || donor.location === searchLocation;
    return matchesBloodGroup && matchesLocation;
  });

  const filteredRequests = requests.filter((request) => {
    const matchesBloodGroup =
      searchBloodGroup === "all" || request.bloodGroup === searchBloodGroup;
    const matchesLocation =
      searchLocation === "all" || request.location.includes(searchLocation);
    return matchesBloodGroup && matchesLocation;
  });
  ...
  const handleSubmitRequest = () => {
    ...
    const request: BloodRequest = {
      ...
      image: newRequest.image
        ? URL.createObjectURL(newRequest.image)
        : undefined,
    };
  ...
  return (
    <div className="min-h-screen py-6 sm:py-8 px-3 sm:px-4">
      <div className="container mx-auto">
        ...
        >
          <motion.div
            className="inline-flex items-center justify-center w-16 h-16 sm:w-20 md:w-24 sm:h-20 md:h-24 rounded-full bg-gradient-to-r from-red-500 to-rose-500 text-white mb-4 sm:mb-6 shadow-2xl"
          ...
          >
            <Droplets className="w-8 h-8 sm:w-10 md:w-12 sm:h-10 md:h-12" />
          </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-2 sm:p-3 mb-6 sm:mb-8 border border-gray-100"
          style={{
        ...
        >
          <div className="flex">
            <motion.button
              ...
              className={`flex-1 py-3 sm:py-4 px-4 sm:px-8 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-lg transition-all flex items-center justify-center space-x-2 sm:space-x-3 ${
                activeTab === "donors"
            ...
            >
              ...
              <span>{t("blood.donors.title")}</span>
            </motion.button>
            <motion.button
            ...
            >
              ...
              <span>{t("blood.requests.title")}</span>
            </motion.button>
          </div>
        </motion.div>
        ...
        >
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              >
                <option value="all">
                  {t("language") === "bn" ? "সব গ্রুপ" : "All Groups"}
                </option>
            ...
            <div>
              ...
              >
                <option value="all">
                  {t("language") === "bn" ? "সব এলাকা" : "All Areas"}
                </option>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="৩ মাসের বেশি আগে">
                            ৩ মাসের বেশি আগে
                          </option>
                          <option value="৬ মাসের বেশি আগে">
                            ৬ মাসের বেশি আগে
                          </option>
                          <option value="১ বছরের বেশি আগে">
                            ১ বছরের বেশি আগে
                          </option>
                        </select>
                      </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-red-100 text-lg">
                          বিস্তারিত তথ্য দিয়ে অনুরোধ করুন
                        </p>
                      </div>
                    </div>
                    <motion.button
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-red-400 transition-colors">
                      ...
                      <label htmlFor="image-upload" className="cursor-pointer">
                        ...
                        <p className="text-gray-600 text-lg">
                          রোগীর ছবি বা প্রেসক্রিপশন আপলোড করুন
                        </p>
                        <p className="text-gray-400 text-sm mt-2">
                          JPG, PNG ফরম্যাট সাপোর্টেড
                        </p>
                      </label>
                      {newRequest.image && (
                        <div className="mt-4">
