...
const FeedbackPage: React.FC = () => {
  ...
  const [feedbacks, setFeedbacks] = useState<Feedback[]>([
    ...
    },
    {
      ...
      message:
        "ডাক্তার খোঁজার সেবা ভাল। তবে আরো বেশি ডাক্তার যোগ করলে ভাল হয়।",
  ...
  return (
    <div className="min-h-screen py-6 sm:py-8 px-3 sm:px-4">
      <div className="container mx-auto">
        ...
        >
          <motion.div
            className="inline-flex items-center justify-center w-16 h-16 sm:w-20 md:w-24 sm:h-20 md:h-24 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white mb-4 sm:mb-6 shadow-2xl"
            whileHover={{ scale: 1.1, rotate: 10 }}
            transition={{ type: "spring", stiffness: 400 }}
          >
            <MessageSquare className="w-8 h-8 sm:w-10 md:w-12 sm:h-10 md:h-12" />
          </motion.div>
