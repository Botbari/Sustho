    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-10 sm:py-16 px-3 sm:px-4">
        ...
        <div className="container mx-auto">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent mb-3">
              Pricing
            </h1>
            <p className="text-gray-600 text-base sm:text-lg px-2">
              Choose a plan that suits your needs. Cancel anytime.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {plans.map((plan, idx) => (
              ...
              >
                <div
                  className={`absolute -inset-0.5 rounded-2xl sm:rounded-3xl bg-gradient-to-r ${plan.gradient} opacity-40 blur-xl group-hover:opacity-60 transition-opacity -z-10`}
                />
                <div className="relative rounded-2xl sm:rounded-3xl bg-white/70 backdrop-blur-xl border border-white/60 shadow-xl p-4 sm:p-6 flex flex-col h-full">
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`inline-flex items-center justify-center w-12 h-12 rounded-2xl text-white bg-gradient-to-r ${plan.gradient} shadow-lg`}
                    >
                      {plan.free ? (
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base px-2">
              Support our mission to make healthcare accessible for everyone by
              becoming a sponsor.
            </p>
          </motion.div>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
              {Array.from({ length: 8 }).map((_, i) => (
                <div
                  key={i}
                  className="relative rounded-2xl bg-white/70 backdrop-blur-xl border border-white/60 shadow-lg p-6 flex items-center justify-center"
                >
      ...
      <section className="relative py-12 sm:py-20 px-3 sm:px-4">
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base px-2">
              Your contribution helps us provide free healthcare services to
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-gray-600">
            {[
              ...
              <div
                key={name}
                className="inline-flex items-center px-4 py-2 rounded-xl bg-white/70 backdrop-blur-xl border border-white/60 shadow"
              >
