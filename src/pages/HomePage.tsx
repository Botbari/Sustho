      ...
      <section className="py-16 px-4 bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50">
        <div className="container mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">{t('home.ai-support.title')}</h2>
            ...
            {[
              {
                ...
                features: [t('common.instant-answer'), t('common.detailed-advice'), t('common.available-24-7')]
              },
              {
                icon: Image,
              ...
              },
              {
                ...
                features: ['Voice Recognition', 'Natural Conversation', 'Easy to Use']
              }
            ].map((method, index) => (
              <motion.div
                key={index}
